  ...
  return (
		<>
			<div className="container mx-auto px-8">
				<p className="text-sm md:text-base xl:text-lg mt-2 px-4 py-6">
				...
				<br></br>
				<br></br>
				<p className="text-sm md:text-base xl:text-lg px-4 ">
                    When I&apos;m not working, I enjoy running, golfing, and spending time with my family. 
                </p>
			</div>
		</>
	);
