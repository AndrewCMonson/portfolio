...
const ContactForm = () => {
	...
	// implement onMouseOut that checks if form is blank and if so, display a message that it is required
						...
						<div className="mb-1 flex flex-col gap-6 content-center">
							...
							<div className="w-80 max-w-screen-lg sm:w-96">
								<div className="relative w-full min-w-[200px]">
									...
									{messageValid ? null : <Typography color="red" className="mt-2">Message is required</Typography>}
								</div>
							</div>
						</div>
						{sent && (
